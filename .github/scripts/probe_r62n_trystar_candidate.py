...
CORE = Path("core")
TARGET = CORE / "tests/infrastructure/test_universal_cross_asset_conformance_final_owner_r62n_guards.py"
...
sys.path.insert(0, str((CORE / "tests/infrastructure").resolve()))
module = importlib.import_module(
    "test_universal_cross_asset_conformance_final_owner_r62n_guards"
)
...
try:
    ...
    result = b("1+1")
'''
print("STATIC_SAFE", module._r62n_dynamic_execution_markers_from_source(static_safe))
print("FINAL_SAFE", module._r62n_dynamic_execution_markers_from_source(final_safe))
